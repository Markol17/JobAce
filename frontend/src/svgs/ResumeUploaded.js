...
export function ResumeUploaded() {
	const img = `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<g>
	...
	const ResumeUploadedSvg = () => <SvgXml xml={img} width="150px" height="150px"/>;
	return <ResumeUploadedSvg />;
}
